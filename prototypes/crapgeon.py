...
#NOTE: add arrows (/). Shoot to one direction and kill the first monster within a range


#define a random location in the map
...
while True:
	...
	while moves < player.speed:
		...
		if potion_drunk:	# if potion is drunk, moves are reset (you get as many free moves as the potion effect states)
